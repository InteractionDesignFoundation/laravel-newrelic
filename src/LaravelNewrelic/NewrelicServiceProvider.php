...
class NewrelicServiceProvider extends ServiceProvider
{
     ...
     */
    protected function registerNamedTransactions(): void
    {
        $app = $this->app;
     ...
     */
    protected function registerQueueTransactions(): void
    {
        $app = $this->app;
     ...
     * @return string
     */
    public function getJobName(JobProcessing $event): string
    {
        return str_replace(
            [
                '{connection}',
    ...
    {
        return strtoupper($this->getRouter()->getCurrentRequest()->method());
    }
    ...
    {
        return $this->getRouter()->getCurrentRequest()->path();
    }
    ...
    {
        $controller = $this->getRouter()->current() ? $this->getRouter()->current()->getActionName() : 'unknown';
    ...
    {
        $name = $this->getRouter()->currentRouteName();
        if (!$name) {
